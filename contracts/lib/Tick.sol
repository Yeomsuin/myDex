...
library Tick {
    ...
    function getFeeGrowthInside(
        ...
        if(tickLower <= tickCurrent){
            ...
            feeGrowthBelow1X128 = feeGrowthGlobal0X128 - lower.feeGrowthOutside1X128;
        }
        ...
        if(tickLower <= tickCurrent){
            ...
            feeGrowthAbove1X128 = feeGrowthGlobal0X128 - upper.feeGrowthOutside1X128; 
        } 
        else{
        ...
        // f_r = f_g - f_b (lowerTick) - f_a (uppderTick)
